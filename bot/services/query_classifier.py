...
class QueryClassifier:
    ...
    def __init__(self):
        ...
        self.technical_patterns = [
            r'\b(мас\w+|смазк\w+|двигател\w+|мото\w+|вязкос\w+|SAE|sae|API|api|ACEA|acea)\b',
            r'\b(автомобил\w+|машин\w+|транспор\w+|техни\w+|FES|fes|ФЕС|фес|ГПУ|гпу)\b',
            r'\b(кама|эскава\w+|мерсе\w+|бмв\w+|маз\w+)\b',
            r'\b(замен\w+|интервал\w+|преиму\w+|расход\w+|температур\w+)\b',
            r'\b(синтетик\w+|минерал\w+|полусинтетик\w+|ecofes|экофес)\b',
            r'\b(фильтр\w+|присадк\w+|антифриз\w+|охлаждающ\w+)\b',
            r'\b(грузовик\w+|порш\w+|устан\w+|газ\w+|автобус\w+|спецтехник\w+|тракт\w+)\b',
        ]
